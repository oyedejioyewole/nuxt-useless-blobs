...
const { data: latestRelease } = await useFetch<{ name: string, html_url: string }>('https://api.github.com/repos/oyedejioyewole/nuxt-useless-blobs/releases/latest', { pick: ['name', 'html_url'] })
</script>
...
<template>
  <nav>
    <div class="flex items-center gap-x-4">
      ...
      >
        <svg
          class="w-8 fill-primary-800 dark:fill-primary-200"
          viewBox="0 0 512 512"
        ...
        <span class="min-lg:inline-block max-lg:sr-only">nuxt-useless-blobs</span>
      </NuxtLink>
